    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl">
        ...
        <div className="flex gap-2 items-center">
          <Button size="sm" variant="secondary" onClick={() => setPath("/")}>
            Root
          </Button>
          <Button
            size="sm"
            variant="secondary"
            onClick={() => setPath("/Desktop")}
          >
            Desktop
          </Button>
          <Button
